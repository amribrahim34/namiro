...
<div class="card w-100">
    <div class="card-header">
        <h5>{{__('products.titles.create')}}</h5>
    </div>
    ...
    <div class="card-block">
        <form class="form-material" method="POST" action="{{route('admin.products.product.store')}}" enctype="multipart/form-data" >
            ...
            <div class="form-group form-default d-flex row">
                <span class="col-2">{{__('products.product_cover')}}</span>
                <input type="file" name="cover" id="" class="form-control col-10">
            </div>
            <div class="form-group form-default">
                <select class="form-control select2" name="subcategory_id" >
                    <option selected="" disabled=""> اختر  {{__('products.subcategory_id')}}</option>
                ...
                <div data-repeater-item class="form-group row mb-5">
                    <div class="form-group form-default col-md-3">
                        <select class="form-control select2" name="color_id" >
                            <option selected="" disabled=""> اختر  {{__('products.color_id')}}</option>
                            @if($colors->count() > 0)
                    ...
                    <div class="form-group form-default col-md-3">
                        <select class="form-control select2" name="material_id" >
                            <option selected="" disabled=""> اختر  {{__('products.material_id')}} </option>
                    ...
                    <div class="row">
                        <span class="col-4"> اختر  {{__('products.stock_cover')}}</span>

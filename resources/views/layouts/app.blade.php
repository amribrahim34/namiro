...
<head>
  ...
  <!-- Css -->
  <link rel="stylesheet" href="{{asset('assets/namira/css/bootstrap.min.css')}}" />
  <link rel="stylesheet" href="{{asset('assets/namira/css/font-icons.css')}}" />
  <link rel="stylesheet" href="{{asset('assets/namira/css/style.css')}}" />
  <link rel="stylesheet" href="{{asset('assets/namira/css/color.css')}}" />

  <!-- Favicons -->
  <link rel="shortcut icon" href="{{asset('assets/namira/img/favicon.ico')}}">
  <link rel="apple-touch-icon" href="{{asset('assets/namira/img/apple-touch-icon.png')}}">
  <link rel="apple-touch-icon" sizes="72x72" href="{{asset('assets/namira/img/apple-touch-icon-72x72.png')}}">
  <link rel="apple-touch-icon" sizes="114x114" href="{{asset('assets/namira/img/apple-touch-icon-114x114.png')}}">
...
<body>
        ...
        <div class="container relative">
                  ...
                  <div class="nav-cart__items">
                    ...
                    <div class="nav-cart__item clearfix">
                      <div class="nav-cart__img">
                        <a href="#">
                          <img src="{{asset('assets/namira/img/shop/cart_small_1.jpg')}}" alt="">
                        </a>
                      </div>
                    ...
                    <div class="nav-cart__item clearfix">
                      <div class="nav-cart__img">
                        <a href="#">
                          <img src="{{asset('assets/namira/img/shop/cart_small_2.jpg')}}" alt="">
                        </a>
                      </div>
                      <div class="nav-cart__title">
                        <a href="#">
          ...
          <div class="flex-parent">
            ...
            <a href="{{route('home')}}" class="logo">
              <img class="logo__img" src="{{asset('assets/namira/img/logo_light.png')}}" alt="logo">
            </a>
                    ...
                    <li>
                      <div class="nav__megamenu-wrap">
                        <div class="row">
                          ...
                          <div class="col nav__megamenu-item">
                            <a href="#"><img src="{{asset('assets/namira/img/shop/megamenu_banner.png')}}" alt=""></a>
                          </div>
  ...
  <!-- jQuery Scripts -->
  <script type="text/javascript" src="{{asset('assets/namira/js/jquery.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/namira/js/bootstrap.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/namira/js/easing.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/namira/js/jquery.magnific-popup.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/namira/js/owl-carousel.min.js')}}"></script>  
  <script type="text/javascript" src="{{asset('assets/namira/js/flickity.pkgd.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/namira/js/modernizr.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('assets/namira/js/scripts.js')}}"></script>
